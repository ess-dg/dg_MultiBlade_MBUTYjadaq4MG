...
def readHDFreducedFileMG(datapathinputAndfilename):
    
    if os.path.exists(datapathinputAndfilename) is False:
         print('\n \033[1;33mWARNING: Reduced DATA file does not exist --> exiting.\033[1;37m')
         sys.exit()
    
    
    f = h5py.File(datapathinputAndfilename, "r")
    ...
    return DurationsALL, MONdata, MONcounts, He3data, He3counts, MOVMMdata, data