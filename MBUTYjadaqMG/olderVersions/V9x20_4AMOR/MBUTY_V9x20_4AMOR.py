...
DistanceWindow1stWire = 38        #mm distance between vessel window and first wire
DistanceAtWindow      = 19000     #mm from chopper to detector window
Distance              = DistanceWindow1stWire + DistanceAtWindow    #mm  flight path at 1st wire
DistanceSampleWindow  = 4000      #mm
