...
# import lib.libMBUTY_V9x14 as mbl 
...
#####################################      
    for ac in range(len(acqnum)):
        ...
        # INPUT col ch, always wires ch from 0 to 31 and strips from 32 to 63 or 95
        [POPH, Nevents, NumeventNoRej] = mbl.clusterPOPH_q(data,Timewindow)
